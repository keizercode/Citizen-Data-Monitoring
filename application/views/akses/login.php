...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <div class="image">
                <img src="<?= base_url('assets/images/stmkg.png') ?>" width="200" height="200" style="display: block;margin: 0 auto" />
            </div>

            <a href="javascript:void(0);"><b>KKN UNIT 4 STMKG 2021</b></a>

        </div>
        <div class="card">
            <div class="body">
                <?= form_open_multipart(site_url('akses/login')); ?>
                <div class="msg">Please Login First</div>
