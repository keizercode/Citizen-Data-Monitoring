...
<head>
    ...
    <title>Unit 4 KKN STMKG 2021</title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= site_url('beranda/p/beranda') ?>" style="text-transform: uppercase;">Unit 4 KKN STMKG 2021</a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
    <section>
        <!-- Left Sidebar -->
        <aside id="leftsidebar" class="sidebar user">
            <!-- User Info -->
            <div class="user-info">
                <div class="image">
