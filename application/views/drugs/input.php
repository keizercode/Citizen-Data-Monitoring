    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="body">
                ...
                <label for="id_drugs">Product ID</label>
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" name="id_drugs" id="id_drugs" value="<?= $val['id_drugs']; ?>" class="form-control">
                    </div>
                </div>
                ...
                up">
                    <div class="form-line">
                        <input type="text" name="type" id="type" value="<?= $val['type']; ?>" class="form-control" placeholder="Enter the product type" maxlength="100">
                    </div>
                </div>
